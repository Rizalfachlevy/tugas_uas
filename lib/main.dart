...
import 'package:news_app_17710113/splash.dart';
import 'package:news_app_17710113/components/customListTile.dart';
import 'package:news_app_17710113/model/article_model.dart';
import 'package:news_app_17710113/services/api_service.dart';
import 'package:news_app_17710113/services/navigation.dart';
...
class berita_bisnis extends State<HomePage2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text("Bussiness News", style: TextStyle(color: Colors.black)),
...
class berita_olahraga extends State<HomePage3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text("Sports News", style: TextStyle(color: Colors.black)),
          backgroundColor: Colors.white),
      body: FutureBuilder(
        future: client.getArticle(),
        builder: (BuildContext context, AsyncSnapshot<List<Article>> snapshot) {
